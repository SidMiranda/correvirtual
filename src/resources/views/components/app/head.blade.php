<head>
    ...
    <link rel="icon" type="image/jpeg" href="{{ asset('images/organizers/'.$organizerId.'logo.png') }}">

    <!-- Ícone para quando o usuário adicionar o site à tela inicial no Android e iOS -->
    <link rel="apple-touch-icon" href="{{ asset('images/organizers/'.$organizerId.'logo.png') }}">
    <link rel="icon" sizes="192x192" href="{{ asset('images/organizers/'.$organizerId.'logo.png') }}">
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('images/organizers/'.$organizerId.'logo.png') }}" />
